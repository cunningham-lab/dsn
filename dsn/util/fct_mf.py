...
def SolveStatic (y0, g, VecPar, eps, tolerance=1e-10, backwards=1):  # y[0]=mu, y[1]=Delta0
...
def SolveStatic2 (y0, g, rho, VecPar, eps, tolerance=1e-10, backwards=1):  # y[0]=mu, y[1]=Delta0
    ...
    while (again==1):
        ...
        mu = Mm * y[2] + Mi
        new1 = g*g * PhiSq(mu, y[1]) + Sim**2 * y[2]**2 + Sii**2
        new2 =  Mn * Phi(mu, y[1]) + Sini * Prime(mu, y[1]); #+ rho*Sim*Sin*y[2] * Prime(mu, y[1])
