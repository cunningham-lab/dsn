...
By recognizing that the equation solver is differentiable, we are able to combine DFMT with EPI to learn distributions on such connectivity parameters of RNNs that \emph{solve} these tasks via an emergent property defined on the DMFT-produced task-relevant responses.  
