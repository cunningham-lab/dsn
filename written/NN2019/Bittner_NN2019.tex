...
What's more, one can derive the RNN responses to parameterized inputs, allowing the design of low-rank RNNs to solve behavioral tasks studied in neuroscience like noisy integration and context-dependent decision making.
