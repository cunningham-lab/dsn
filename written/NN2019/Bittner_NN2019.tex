...
For EPI in Fig 2C, we used a real NVP architecture with two coupling layers.  Each coupling layer had two hidden layers of 10 units each, and we mapped onto a support of $z \in \left[ \begin{bmatrix} 4 \\ 0 \end{bmatrix}, \begin{bmatrix} 8 \\ 4 \end{bmatrix} \right]$. We used an augmented Lagrangian coefficient of $c_0 = 2$.
...
The length of the arrows is inversely proportional to the square root of absolute value of their eigenvalues $\lambda_1 = -10.9$ and $\lambda_2 = -2.34$.
