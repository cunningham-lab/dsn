...
To continue our running STG example, one such emergent property is the phenomenon of \emph{network syncing} -- in certain parameter regimes, the frequency of the hub neuron matches that of the fast and slow populations at an intermediate frequency.  This emergent property is shown in Figure 1A.
...
Primarily, it has revealed structure in large-scale neural data sets \cite{kass2001spike, brown1998statistical, paninski2004maximum, byron2009gaussian, latimer2015single, duncker2019learning} (see review, \cite{paninski2018neural}).  
...
Neuoroscientists should turn focus to the primary benefit machine learning can offer: theorists can use deep learning for probabilistic inference to understand their \textit{models} rather than the experimental data sets it has been traditionally purposed for.
