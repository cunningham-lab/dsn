...
Seminal examples of this gold standard include our field's understanding of memory capacity in associative neural networks \cite{hopfield1982neural} and chaos and autocorrelation timescales in random neural networks \cite{sompolinsky1988chaos} (which use models and analyses originating in physics), as well as  the paradoxical effect in excitatory/inhibitory networks \cite{tsodyks1997paradoxical}.
% [[perhaps add these]] \cite{wong2006?}, more examples \cite{machensbrody2005?}.
