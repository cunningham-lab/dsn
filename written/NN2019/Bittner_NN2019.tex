...
The eigenvectors of the distribution Hessian at the mode can be queried to quantitatively formalize the robustness of network syncing (Fig. \ref{fig:STG}B $v_1$ and $v_2$).
