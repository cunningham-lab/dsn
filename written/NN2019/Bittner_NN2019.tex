...
$a_1$ and $a_4$. Intuitively, the parameters degenerate with respect to emergent property statistic $\text{real}(\lambda_1)$ have similar log densities.
...
\subsubsection{DSNs as VI in an exponential family conditioned on $\mu$}\label{methods_VI}
I'll clean this up. \\
