...
%[I'd say no to GANs here. MCMC?  Is SMC ABC the deep learning ABC you refer to? Things like sequential neural likelihood (SNL, Leuckman/Papamakarios), LFVI (Dustin) and eventually SNPE will be covered more extensively in appendix, correct?].  
