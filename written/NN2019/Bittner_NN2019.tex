...
\begin{equation}\label{eq:EP}
 E\left[T(x) \right] =\mu
 \end{equation}
where the first and second moments of these frequencies are chosen such that each neuron is firing near the network syncing frequency: $E\left[\Omega_i \right] = 0.55$ and $E\left[(\Omega_i - 0.55) \right] = 0.025^2$ for $i \in \{ \text{f1}, \text{f2}, \text{hub}, \text{s1}, \text{s2} \}$.
