...
While we have advanced our research on deep generative modeling \cite{loaiza2017maximum} to a point of significant relevance to statistical inference in theoretical neuroscience, they have also furthered their research on approximate Bayesian inference inference in such models \cite{LueckmannGoncalves_17}.
...
Despite full knowledge of STG connectivity and a precise characterization of its rhythmic pattern generation, biophysical models of the STG have compilcated relationships between circuit parameters and neural activity \cite{goldman2001global, prinz2004similar}.
...
Indeed, samples equidistant from the mode along these EPI-identified dimensions of sensitivity ($v_1$) and degeneracy ($v_2$) have diminished or preservered network syncing, respectively (Figure 1B inset and activity traces). 
